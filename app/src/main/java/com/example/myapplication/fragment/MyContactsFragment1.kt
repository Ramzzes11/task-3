...
import com.example.myapplication.databinding.FragmentMyContacts1Binding
import com.example.myapplication.databinding.MyContactBinding
...
class MyContactsFragment1 : Fragment(), ContactAdapter.Listener {

    lateinit var bindingContact: FragmentMyContacts1Binding
    ...
    override fun onCreateView(
        ...
        bindingContact = FragmentMyContacts1Binding.inflate(layoutInflater,container,false)
    ...
    override fun openContactProfile(
        ...
        args.putString("Photo",inCircleGlide)

        val contactFragmentProfile = ContactFragmentProfile1()
        contactFragmentProfile.arguments = args
        ...
        parentFragmentManager
            ...
            .addToBackStack(null)
            .replace(R.id.container1,contactFragmentProfile)
            .commit()
    }
