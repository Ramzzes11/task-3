...
class ContactFragmentProfile : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val args: ContactFragmentProfileArgs by navArgs()

        binding.nameSurname.text = args.nameSurname
        binding.career.text = args.career
        getInCircleGlide(args.photo,binding.contactImage)
    }
}